  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Hero body */}
        <div style={{ Width:"100%", margin:"0 auto", padding:"42px 24px 62px", textAlign:"center", position:"relative" }}>
      ...
      {/* ══ MAIN ══ */}
      <div style={{ background:"#f2fdfb", Width:"100%", margin:"0 auto", padding:"38px 20px 80px" }}>
